    ...
    <footer className="bg-blue-600 text-white py-12">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Column 1: About */}
          <div>
            <h3 className="text-xl font-bold mb-4">Broadway Enterprise</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to={`/${language}/enterprise`} className="text-white/80 hover:text-brand-orange transition-colors">
                  {t('navigation.home')}
                </Link>
              </li>
              <li>
                <Link to={`/${language}/enterprise/about`} className="text-white/80 hover:text-brand-orange transition-colors">
                  {t('navigation.about')}
                </Link>
              </li>
              <li>
                <Link to={`/${language}/enterprise/services`} className="text-white/80 hover:text-brand-orange transition-colors">
                  {t('enterprise.servicesTitle')}
                </Link>
              </li>
              <li>
                <Link to={`/${language}/enterprise/impact`} className="text-white/80 hover:text-brand-orange transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-white/20 text-center text-white/60">
          <p>&copy; {currentYear} Broadway Enterprise. {t('footer.rights')}</p>
          <div className="mt-4 flex justify-center space-x-4">
            <Link to={`/${language}/enterprise/privacy`} className="hover:text-brand-orange transition-colors">
              {t('footer.privacy')}
            </Link>
            <Link to={`/${language}/enterprise/terms`} className="hover:text-brand-orange transition-colors">
              {t('footer.terms')}
            </Link>
