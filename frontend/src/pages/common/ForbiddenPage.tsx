...
const ForbiddenPage = () => {
  ...
  return (
    <Layout
      title={`${t('errors.forbidden.title')} - Broadway Corporation`}
      description={t('errors.forbidden.description')}
    >
      <div className="container-custom py-16 text-center">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-7xl font-bold text-brand-navy mb-6">{t('errors.forbidden.code')}</h1>
          <h2 className="text-3xl font-bold text-gray-700 mb-4">{t('errors.forbidden.title')}</h2>
